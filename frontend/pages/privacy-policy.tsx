    ...
    <main className="terms-style px-10 md:px-20 lg:px-[15rem] xl:px-[25rem] py-10 dark:text-white">
      ...
      <ol>
        ...
        <li>
          ...
          <p>
            We don’t use much of the information, but we may need to use it to operate and manage the Services on this Site (or other places), provide you with support, ensure our compliance with applicable laws and regulations, and enforce the security of the Site or make other improvements.
          </p>
          <p>
        ...
        <li>
          ...
          <p>Relax. We don’t use Google Analytics (or other analytics services).  </p>
        </li>
        <li>
          <h2>
            <b>7.</b>
        ...
        <li>
          ...
          <p>
            We do our absolute best you keep your data safe always.
          </p>
          <p>
