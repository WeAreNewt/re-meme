...
export const RemixShareBox: React.FC<RemixShareBoxProps> = ({ publication }) => {
    ...
    return (
        <div className="main-container">
            <a target="_blank" rel="noreferrer" href={`${selectedEnvironment.lensterUrl}/posts/${publication.id}`} className="btn-medium-secondary no-underline hover:text-neutral-black w-full mb-[16px]">Collect meme on Lenster</a>
