        ...
        <div className={show ? "block" : "hidden"}>
            <div className="absolute h-screen w-screen z-20 flex items-center justify-center create-btn-gradient-transparent">
                <div className="comic-border rounded-4xl bg-white p-10">
                    <h3 className="text-3xl text-center font-extrabold whitespace-pre-line px-8">{"Are you sure you want\n to remix?"}</h3>
                    <p className="text-lg text-center whitespace-pre-line px-8">This remix will live on Lens forever</p>
