        ...
        <li>
          ...
          <li>
            ...
            <p className="flex flex-col">
              ...
              <span>Email:  <a className="text-black" href="mailto:IP@aave.com">IP@aave.com </a></span>
            </p>
          ...
          <li>
            ...
            <p>
              <b>We reserve the right to block your wallet to prevent you from engaging with the Site and Services.</b>
            </p>
            <p>
          ...
          <li>
            <h3>
              <b>16. ARBITRATION AGREEMENT AND WAIVER OF RIGHTS, INCLUDING CLASS ACTIONS</b>
            </h3>
            <p>
